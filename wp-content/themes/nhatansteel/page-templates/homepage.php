    ...
    <section class="service-section">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="service-box">
                ...
                <a href="<?php
                   echo (substr(get_locale(), 0, 2) === 'en') ? '/en/products-services/?services=yes#thiet-ke' : '/san-pham-dich-vu?services=yes#thiet-ke';
            ...
            <div class="service-box">
                ...
                <a href="<?php
                   echo (substr(get_locale(), 0, 2) === 'en') ? '/en/products-services/?services=yes#gia-cong' : '/san-pham-dich-vu?services=yes#gia-cong';
                ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/i-arrow-right-blue.svg" alt="arrow blue" class="img-fluid" width="22"></a>
                </div>
                <a href="<?php
                   echo (substr(get_locale(), 0, 2) === 'en') ? '/en/products-services/?services=yes#gia-cong' : '/san-pham-dich-vu?services=yes#gia-cong';
            ...
            <div class="service-box">
                ...
                <a href="<?php
                   echo (substr(get_locale(), 0, 2) === 'en') ? '/en/products-services/?services=yes#lap-dung' : '/san-pham-dich-vu?services=yes#lap-dung';
                ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icons/i-arrow-right-blue.svg" alt="arrow blue" class="img-fluid" width="22"></a>
                </div>
                <a href="<?php
                   echo (substr(get_locale(), 0, 2) === 'en') ? '/en/products-services/?services=yes#lap-dung' : '/san-pham-dich-vu?services=yes#lap-dung';
